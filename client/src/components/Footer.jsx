...
const Footer = () => {
    return (
        <footer className="p-4 py-10 bg-gray-900 text-white sm:p-6">
            <div className="mx-auto max-w-screen-xl">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0 flex items-center">
                        <NavLink to="http://localhost:5173" className="flex items-center">
                            <img src="http://localhost:5173/public/favicon-32x32.png" className="mr-3 h-8" alt="FoodDelivery Logo" />
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-orange-400">FoodMine</span>
                        </NavLink>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-white sm:text-center">© 2024 <NavLink to="http://localhost:5173/" className="hover:underline">FoodMine™</NavLink>. All Rights Reserved.
                    </span>
                    {/* <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="#" className="text-white hover:text-gray-900 dark:hover:text-gray-500">
